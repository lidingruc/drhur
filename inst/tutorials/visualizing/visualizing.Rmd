...
knitr::include_graphics("../visualizing_cn/images/picThanWords.jpg")
```
...
::: centered
<img src="../visualizing_cn/images/hiveplot.png" height="450"/>
:::

### Maps

::: center
<img src="../visualizing_cn/images/ggmap.png" height="600"/>
:::

### Interactive plots

::: center
<img src="../visualizing_cn/images/interactive3D.gif" height="550"/>
:::
...
2.  COVID-19 Case Fatality Rate (Bar plot)
3.  COVID-19 Incubation Time (Fan plot)
...
-   Embedded in R
-   Good tool for [data exploration]{style="color:purple"}.
-   [Spatial]{style="color:purple"} analysis and [3-D]{style="color:purple"} plots.
...
```{r out.width = "80%", echo = FALSE}
knitr::include_graphics("../visualizing_cn/images/ggplot_geom.png")
```
...
2.  Pretty ∝ complexity.
3.  The fancier is unnecessarily the better.
