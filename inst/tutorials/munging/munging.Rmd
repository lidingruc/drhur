...
knitr::include_graphics("../munging_cn/images/tidyverseHive.png")
```
...
knitr::include_graphics("../munging_cn/images/simple.png")
```

### Composability: Make Everything Different

```{r out.width = "95%", echo = FALSE}
knitr::include_graphics("../munging_cn/images/composable.png")
```
...
```{r out.width = "95%", echo = FALSE}
knitr::include_graphics("../munging_cn/images/arrange.png")
```

```{r out.width = "95%", echo = FALSE}
knitr::include_graphics("../munging_cn/images/desc.png")
```
...
```{r out.width = "95%", echo = FALSE}
knitr::include_graphics("../munging_cn/images/summarise.png")
```
...
```{r out.width = "95%", echo = FALSE}
knitr::include_graphics("../munging_cn/images/group_by.png")
```
...
```{r out.width = "95%", echo = FALSE}
knitr::include_graphics("../munging_cn/images/filter.png")
```
...
```{r out.width = "95%", echo = FALSE}
knitr::include_graphics("../munging_cn/images/select.png")
```
...
```{r out.width = "95%", echo = FALSE}
knitr::include_graphics("../munging_cn/images/comboAttack.gif")
```
...
```{r out.width = "95%", echo = FALSE}
knitr::include_graphics("../munging_cn/images/mutate.png")
```
