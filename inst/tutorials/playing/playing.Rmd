...
knitr::include_graphics("../playing_cn/images/APLkeyBoard.png")
```
...
```{r out.width = "60%", echo = FALSE}
knitr::include_graphics("../playing_cn/images/handShadow.gif")
```
...
```{r out.width = "60%", echo = FALSE}
knitr::include_graphics("../playing_cn/images/matrix.gif")
```
...
knitr::include_graphics("../playing_cn/images/excel-r1.png")
```
...
```{r rstudio}
knitr::include_graphics("../playing_cn/images/excel-r2.png")
```
...
knitr::include_graphics("../playing_cn/images/rowBind.png")
```
...
```{r out.width = "95%", echo = FALSE}
knitr::include_graphics("../playing_cn/images/columnBind.png")
```
...
```{r out.width = "95%", echo = FALSE}
knitr::include_graphics("../playing_cn/images/join.png")
```
